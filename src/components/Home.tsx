...
const Home = () => {
  return (
    <Container text style={{ marginTop: '7em' }}>
      ...
      <Header as='h1'>
        HYUN SUNG KIM
        <Header.Subheader>Front-end developer || Designer</Header.Subheader>
      </Header>
      ...
      <Header as='h3' style={{ margin: '0 0 2em 1em' }}>
        ...
        <Header as='h4'>
          ...
          <Header.Subheader>Mar 2019 – Present</Header.Subheader>
        </Header>
      </Header>
      ...
      <Header as='h3' style={{ margin: '0 0 2em 1em' }}>
        ...
        <Header as='h4'>
          ...
          <Header.Subheader>Feb 2017 – May 2017</Header.Subheader>
        </Header>
      </Header>
      ...
      <Header as='h3' style={{ margin: '0 0 2em 1em' }}>
        ...
        <Header as='h4'>
          Graphic Designer
          <Header.Subheader>2015 – 2018</Header.Subheader>
        </Header>
      </Header>
      <Header as='h2'>
      ...
      <Header as='h3' style={{ margin: '0 0 2em 1em' }}>
        ...
        <Header as='h4'>
          ...
          <Header.Subheader>2014 – 2016</Header.Subheader>
        </Header>
      </Header>
