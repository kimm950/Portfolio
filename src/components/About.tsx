      ...
      <div className='about-wrppper'>
        <Card style={{ marginBottom: '2em' }}>
          ...
          <Card.Content>
            ...
            <Card.Meta><span className='date'>Feb 17th 1995</span></Card.Meta>
            <Card.Description>Hi! I am a front-end developer living in Tokyo.</Card.Description>
          </Card.Content>
        </Card>
        <List>
          <List.Item>
          ...
          <List.Item>
            <List.Icon name='mail' />
            <List.Content><a href='mailto:kimuo950@gmail.com'>kimuo950@gmail.com</a></List.Content>
          </List.Item>
          <List.Item>
            <List.Icon name='github' />
            <List.Content><a href='https://github.com/kimm950' target='blank'>https://github.com/kimm950</a></List.Content>
          </List.Item>
        </List>
      </div>
